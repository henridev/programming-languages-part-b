...
; OPTION 2: precompute argument two
...
; OPTION 3: thunk using promise as argument two 
; the (bool tunk) pair will be put in value x 
; then to my-mult we actually pass a thunk forcing return from the promise 
; this return will either already be calculated or not 
